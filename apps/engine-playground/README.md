...
Minimal browser demonstration for Hustle Core Tasks 001–003. It uses rectangles, counters, and text to show deterministic mocked round execution, queue controls, interruption, snapshot recovery, malformed input, animation failure, the reusable Hustle Debug Panel, and Feature SDK inspection.
